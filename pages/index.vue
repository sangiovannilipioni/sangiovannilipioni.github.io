  ...
  <div>
    <div class="container flex">
      ...
      <div style="height: 400px; max-height: 30%; width: 100%; margin: 2rem 0" class="binome">
        ...
        <div id="pano" class="col d-flex justify-content-center align-items-center" style="background: transparent">
          <font-awesome-icon :icon="['fas', 'spinner']" class="fa-spin" />
        </div>
      </div>
      <p style="font-size: larger" v-html="$t('pres1')"></p>
      <p v-html="$t('pres2')"></p>
      <p v-html="$t('pres3')"></p>
      <p v-html="$t('pres4')"></p>
      <ol>
  ...
  methods: {
    ...
    async initialize() {
      ...
      const contentString =
        ...
        this.$t("googlePopup") +
        "</p>" +
        '<p>cf. <a target="_blank" href="' +
        this.$t("googlePopupLinkToWikipedia") +
        '">' +
        "" +
        this.$t("googlePopupLinkToWikipedia") +
        "</a>" +
